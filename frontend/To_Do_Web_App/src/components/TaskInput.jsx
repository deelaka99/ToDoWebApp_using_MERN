  ...
  return (
    <div className="w-full h-auto flex items-center justify-center">
      <div className="flex pt-3 mobile:gap-1 tablet:gap-2">
        ...
        />
        <button className="bg-green text-white h-auto w-auto mobile:px-2 tablet:px-3 laptop:px-2 mobile:rounded-[6px] laptop:rounded-[5px] drop-shadow active:bg-darkGrey active:drop-shadow-md">
          <FontAwesomeIcon
