  ...
  return (
    <div className="w-full h-auto flex items-center justify-center">
      <div className="flex pt-3 gap-1">
        <input
          type="text"
          className="bg-white font-inter mobile:w-[227px] mobile:h-[36px] mobile:rounded-[3px] mobile:pl-2 mobile:text-[12px] text-textGrey outline-none focus:ring-2 drop-shadow placeholder:text-placeholderGrey"
